...
pub(crate) mod splash {
    ...
    impl Plugin for SplashPlugin {
        fn build(&self, app: &mut App) {
            ...
            if (app.get_schedule(OnEnter(GameState::Splash)).is_none()) {
                app.add_schedule(OnEnter(GameState::Splash), Schedule::new());
            }
            if (app.get_schedule(OnEnter(GameState::Splash)).is_none()) {
                app.add_schedule(OnExit(GameState::Splash), Schedule::new());
            }
...
pub(crate) mod game {
    ...
    impl Plugin for GamePlugin {
        fn build(&self, app: &mut App) {
            if (app.get_schedule(OnEnter(GameState::Game)).is_none()) {
                app.add_schedule(OnEnter(GameState::Game), Schedule::new());
            }
            if (app.get_schedule(OnExit(GameState::Game)).is_none()) {
                app.add_schedule(OnExit(GameState::Game), Schedule::new());
            }
            app
                .add_systems((
...
pub(crate) mod menu {
    ...
    impl Plugin for MenuPlugin {
        fn build(&self, app: &mut App) {
            if (app.get_schedule(OnEnter(GameState::Menu)).is_none()) {
                app.add_schedule(OnEnter(GameState::Menu), Schedule::new());
            }
            if (app.get_schedule(OnExit(GameState::Splash)).is_none()) {
                app.add_schedule(OnExit(GameState::Splash), Schedule::new());
            }
            app
